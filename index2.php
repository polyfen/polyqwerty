    ...
    <body class="light-mode">
        ...
        <div class="container">
            ...
            <section id="diacritics">
                ...
                <h3>l</h3>
                <h4>Ĺ	ĺ	Ľ	ľ	Ļ	ļ	Ḽ	ḽ	Ḷ	ḷ	Ḹ	ḹ	Ḻ	ḻ</h4>
               ...
               <button id="dot-below-m" class="key" title="Dot Below m">&#x1E43;</button>
                ...
                <h3>n</h3>
                <h4>Ń	ń	Ň	ň	Ņ	ņ	Ṋ	ṋ	Ṅ	ṅ	Ṇ	ṇ	Ǹ	ǹ	Ṉ	ṉ	Ñ	ñ</h4>
                ...
                <h3>r</h3>
                <h4>Ŕ	ŕ	Ř	ř	Ŗ	ŗ	Ṙ	ṙ	Ṛ	ṛ	Ṝ	ṝ	Ȑ	ȑ	Ȓ	ȓ	Ṟ	ṟ</h4>
                ...
                <h3>s</h3>
                <h4>Ś	ś	Ṥ	ṥ	Š	š	Ṧ	ṧ	Ş	ş	Ŝ	ŝ	Ș	ș	Ṡ	ṡ ẛ	Ṣ	ṣ	Ṩ	ṩ</h4>
                ...
                <h3>t</h3>
                <h4>Ť	ť	Ţ	ţ	Ṱ	ṱ	Ț	ț	ẗ	Ṫ	ṫ	Ṭ	ṭ	Ṯ	ṯ</h4>
                ...
                <h3>w</h3>
                <h4>Ẃ	ẃ	Ŵ	ŵ	Ẅ	ẅ	Ẇ	ẇ	Ẉ	ẉ	Ẁ	ẁ	ẘ</h4>
                ...
                <h3>y</h3>
                <h4>Ý	ý	Ŷ	ŷ	Ÿ	ÿ	Ẏ	ẏ	Ỵ	ỵ	Ỳ	ỳ	Ỷ	ỷ	Ȳ	ȳ	ẙ	Ỹ	ỹ</h4>
                ...
                <p id="p1">Hello, I'm a placeHolder</p>
                <input type="text">
...
<section id="diacritics">
            ...
            <div class="key-section">
                ...
                <button id="diaeresis-capital-h" class="key" title="Diaeresis H">&#x1E26;</button>
                <button id="diaeresis-h" class="key" title="Diaeresis h">&#x1E27;</button>
                <button id="dot-below-capital-h" class="key" title="Dot below H">&#x1E24;</button>
                <button id="dot-above-h" class="key" title="Dot Above h">&#x1E25;</button>
                <button id="dot-above-capital-h" class="key" title="Dot Above H">&#x1E22;</button>
                <button id="dot-below-h" class="key" title="Dot Below h">&#x1E23;</button>
                <button id="line-below-h" class="key" title="Line Below h">&#x1E96;</button>

                <button id="caron-j" class="key" title="Caron j">&#x01F0;</button>
                <button id="circumflex-capital-j" class="key" title="Circumflex J">&#x0134;</button>
                <button id="circumflex-j" class="key" title="Circumflex j">&#x0135;</button>
